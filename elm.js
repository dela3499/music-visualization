...
var _user$project$MusicAnalyzer$getLast = function (xs) {
	return _elm_lang$core$List$head(
		_elm_lang$core$List$reverse(xs));
};
var _user$project$MusicAnalyzer$serverBaseUrl = 'http://localhost:8080/youtube/';
var _user$project$MusicAnalyzer$youtubeBaseUrl = 'https://www.youtube.com/watch?v=';
var _user$project$MusicAnalyzer$showImage = function (id) {
	var _p0 = id;
	switch (_p0.ctor) {
		case 'YouTube':
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A2(_elm_lang$core$Basics_ops['++'], _user$project$MusicAnalyzer$serverBaseUrl, _p0._0))
					]),
				_elm_lang$core$Native_List.fromArray(
					[]));
		case 'Error':
...
var _user$project$MusicAnalyzer$NoID = {ctor: 'NoID'};
var _user$project$MusicAnalyzer$initialModel = {id: _user$project$MusicAnalyzer$NoID};
var _user$project$MusicAnalyzer$Error = function (a) {
	return {ctor: 'Error', _0: a};
};
var _user$project$MusicAnalyzer$YouTube = function (a) {
	return {ctor: 'YouTube', _0: a};
};
var _user$project$MusicAnalyzer$getID = function (string) {
	var id = _user$project$MusicAnalyzer$getLast(
...
var _user$project$MusicAnalyzer$SetID = function (a) {
	return {ctor: 'SetID', _0: a};
};
var _user$project$MusicAnalyzer$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$placeholder('Put in a Youtube URL!'),
						_elm_lang$html$Html_Events$onInput(
						function (string) {
							return _user$project$MusicAnalyzer$SetID(string);
						})
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
...
var _user$project$MusicAnalyzer$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: {ctor: '_Tuple2', _0: _user$project$MusicAnalyzer$initialModel, _1: _user$project$MusicAnalyzer$initCmd},
			view: _user$project$MusicAnalyzer$view,
			update: _user$project$MusicAnalyzer$update,
			subscriptions: _user$project$MusicAnalyzer$subscriptions
		})
};

var Elm = {};
Elm['MusicAnalyzer'] = Elm['MusicAnalyzer'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['MusicAnalyzer'], 'MusicAnalyzer', typeof _user$project$MusicAnalyzer$main === 'undefined' ? null : _user$project$MusicAnalyzer$main);
